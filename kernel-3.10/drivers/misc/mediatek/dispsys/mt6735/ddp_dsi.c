	...
	else if(state == CMDQ_ESD_CHECK_CMP)
	{
		...
		for(i = 0; i < 3; i++)
		{
			...
			if(hSlot)
			{
				...
				cmdqBackupReadSlot(hSlot[1], i, &read_data1); //add by haitao
...
/*			DISPDBG("[DSI]enter cmp read_data0 0x%x \n",read_data0);
			DISPDBG("[DSI]enter cmp read_data1 0x%x \n",read_data1);
			DISPDBG("[DSI]enter cmp read_data2 0x%x \n",read_data2);
			DISPDBG("[DSI]enter cmp read_data3 0x%x \n",read_data3);	*/		
...
//				DISPCHECK("DSI read long packet size: %d\n", recv_data_cnt);
				...
				if(recv_data_cnt == 1)
				{
					DISPCHECK("read_data1.byte0 = 0x%x\n",read_data1.byte0);
				...
				else if(recv_data_cnt == 3)
				{
	//				DISPCHECK("read_data1.byte0 = 0x%x,read_data1.byte1 = 0x%x,read_data1.byte2 = 0x%x\n",read_data1.byte0,read_data1.byte1,read_data1.byte2);
					if(read_data1.byte0 == dsi_params->lcm_esd_check_table[i].para_list[0]
						&& read_data1.byte1 == dsi_params->lcm_esd_check_table[i].para_list[1]
       		...
       		else
       		{
				...
				if(recv_data_cnt == 1)
				{
	//				DISPCHECK("read_data0.byte1 = 0x%x\n",read_data0.byte1);
				...
				{
					if(read_data0.byte1 == dsi_params->lcm_esd_check_table[i].para_list[0]
						&& read_data0.byte2 == dsi_params->lcm_esd_check_table[i].para_list[1])
					{
						ret = 0; // esd pass
					}
					else
				...
				{
//					DISPCHECK("read_data0.byte1 = 0x%x,read_data0.byte2 = 0x%x,read_data0.byte3 = 0x%x\n",read_data0.byte1,read_data0.byte2,read_data0.byte3);
					if(read_data0.byte1 == dsi_params->lcm_esd_check_table[i].para_list[0]
						&& read_data0.byte2 == dsi_params->lcm_esd_check_table[i].para_list[1]
						&& read_data0.byte3 == dsi_params->lcm_esd_check_table[i].para_list[2])
					{
						ret = 0; // esd pass
					}
			  	    else
