...
//rgk lcm drvier start---------------------------------
extern LCM_DRIVER hx8394d_dsi_vdo_hlt_hsd_hd720_lcm_drv;
extern LCM_DRIVER nt35521_dsi_vdo_yushun_cmi_hd720_lcm_drv;
extern LCM_DRIVER ili9881c_dsi_vdo_hlt_hd720_boe_ips_lcm_drv;
extern LCM_DRIVER ili9881c_dsi_vdo_dj_hd720_cmi_ips_lcm_drv;
//rgk lcm drvier end-----------------------------------
...
#if defined(ILI9881C_DSI_VDO_HLT_HD720_BOE_IPS)
    &ili9881c_dsi_vdo_hlt_hd720_boe_ips_lcm_drv,
#endif

#if defined(ILI9881C_DSI_VDO_DJ_HD720_CMI_IPS)
    &ili9881c_dsi_vdo_dj_hd720_cmi_ips_lcm_drv,
#endif
//rgk lcm drvier end-----------------------------------
};
