...
#define DW9719AFIOC_G_MOTORINFO _IOR(DW9719AF_MAGIC,0,stDW9719AF_MotorInfo)

#define DW9719AFIOC_T_MOVETO _IOW(DW9719AF_MAGIC,1,u32)

#define DW9719AFIOC_T_SETINFPOS _IOW(DW9719AF_MAGIC,2,u32)

#define DW9719AFIOC_T_SETMACROPOS _IOW(DW9719AF_MAGIC,3,u32)
#ifdef LensdrvCM3
#define DW9719AFIOC_G_MOTORMETAINFO _IOR(DW9719AF_MAGIC, 4, stDW9719AF_MotorMETAInfo)
#endif
