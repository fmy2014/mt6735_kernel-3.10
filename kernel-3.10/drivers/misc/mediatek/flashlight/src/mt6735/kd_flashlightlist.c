...
//lisong 2015-6-5 [BUGID:DWYLL-37][disable low bat percent protect for flashlight]start    
//	register_battery_percent_notify(&bat_per_protection_powerlimit_flashlight, BATTERY_PERCENT_PRIO_FLASHLIGHT);
//lisong 2015-6-5 [BUGID:DWYLL-37][disable low bat percent protect for flashlight]end
