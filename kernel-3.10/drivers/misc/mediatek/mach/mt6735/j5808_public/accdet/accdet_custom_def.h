...
//lisong 2015-5-27 [BUGID:NULL][EUROPE_AMERICA_STANDARD_COMPATIBLE]start
#define EUROPE_AMERICA_STANDARD_COMPATIBLE
//lisong 2015-5-27 [BUGID:NULL][EUROPE_AMERICA_STANDARD_COMPATIBLE]end
