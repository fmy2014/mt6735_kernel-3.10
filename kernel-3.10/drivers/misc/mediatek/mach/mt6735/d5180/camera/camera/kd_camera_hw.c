...
u32 pinSet[3][8] = {
	...
	if(currSensorName && (0 == strcmp(SENSOR_DRVNAME_ST_GC2355_MIPI_RAW,currSensorName)))
	{
		PK_DBG("XXXXXXXXXX SP2755 sensor PDN off is one\n");
		pinSet[1][IDX_PS_CMPDN + IDX_PS_ON] = GPIO_OUT_ZERO;
		pinSet[1][IDX_PS_CMPDN + IDX_PS_OFF] = GPIO_OUT_ONE;
    ...
    if (On) {
        ...
        else  if (currSensorName && (0 == strcmp(SENSOR_DRVNAME_ST_GC2355_MIPI_RAW, currSensorName)))
        {
...
/* HI841 START */
                ...
                && (0 == strcmp(SENSOR_DRVNAME_HI841_2LANE_MIPI_RAW,currSensorName))
                )
        {
////////////////////////// FIXME:the same as hi545????? ///////////////////////////
           PK_ERR( "TURN ON hi841!@%d start!", __LINE__ );
          ...
          if(pinSetIdx == 0 || pinSetIdx == 2) {//disable sub
              ...
              if (GPIO_CAMERA_INVALID != pinSet[0][IDX_PS_CMRST]) {
                ...
                PK_ERR( "TURN ON hi841!@%d end", __LINE__ );
        }
/* HI841 END */		
...
/* HI841 START */
        ...
        {
            PK_ERR("POWER DOWN hi841!@%d", __LINE__ );
