...
static void sensor_init(void)
{
    ...
    */
    ...
    // Horizontal binning
    write_cmos_sensor(0x3820, 0x0e); // flip off, v bin off
...
static void capture_setting(kal_uint16 currefps)
{
    ...
    /********************************************************
       ...
       *
       ********************************************************/
    write_cmos_sensor(0x3820, 0x46); // flip off, v bin off
    write_cmos_sensor(0x3821, 0x00); // mirror on, v bin off
...
static void video_1080p_setting(void)
{
    ...
    /********************************************************
       ...
       ********************************************************/
    write_cmos_sensor(0x3820, 0x46); // flip off, v bin off
    write_cmos_sensor(0x3821, 0x00); // mirror on, h bin on
