...
u32 pinSet[3][8] = {
    ...
    if (On) {
        ...
        PK_DBG("[PowerON]pinSetIdx:%d, currSensorName: %s\n", pinSetIdx, currSensorName);
		 ...
		 if (currSensorName && (0 == strcmp(SENSOR_DRVNAME_DJ_OV8865_MIPI_RAW,currSensorName)))
		{
            ...
            PK_DBG("kdCISModulePowerOn get in---  SENSOR_DRVNAME_DJ_OV8865_MIPI_RAW \n");
	 ...
	 if(currSensorName && (0 == strcmp(SENSOR_DRVNAME_DJ_OV8865_MIPI_RAW,currSensorName)))
        {
            PK_DBG("kdCISModulePower--off get in---SENSOR_DRVNAME_DJ_OV8865_MIPI_RAW \n");
