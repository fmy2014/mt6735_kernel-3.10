...
extern void otp_apply_lenc();
extern bool otp_update_wb();
extern bool otp_apply_wb();
bool otp_flag=0;
...
static void sensor_init(void)
{
  ...
  write_cmos_sensor(0x583e,0x80);//lens maxgain		50
  write_cmos_sensor(0x583f,0x60);//lens mingain			30
  write_cmos_sensor(0x5840,0x00);
  write_cmos_sensor(0x5841,0x0d);
...
static kal_uint32 open(void)
{
	...
	sensor_init();
	if(otp_update_wb()&&otp_update_lenc())
	{
		otp_flag = 1;
		LOG_INF("OTP?¨®??3¨¦1|");
		otp_update_wb();
