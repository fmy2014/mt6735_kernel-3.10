...
static void sensor_init(void)
{
  ...
  write_cmos_sensor(0x40A0, 0x01); //BLC offset on
  //write_cmos_sensor(0x40b4, 0x40);
  //write_cmos_sensor(0x40b5, 0x40);
  //write_cmos_sensor(0x40b6, 0x40);
  //write_cmos_sensor(0x40b7, 0x40);

  write_cmos_sensor(0x40A1, 0x3D);
  write_cmos_sensor(0x40A2, 0x80);
  write_cmos_sensor(0x40A6, 0x16);
  write_cmos_sensor(0x40AC, 0x03);
  write_cmos_sensor(0x40AD, 0x30);
  ...
  write_cmos_sensor(0x41D1, 0xBF);
  write_cmos_sensor(0x41D2, 0x00);
  write_cmos_sensor(0x41D3, 0x9A);

  write_cmos_sensor(0x41D6, 0x00);
  write_cmos_sensor(0x41D7, 0xE3);
  write_cmos_sensor(0x41D4, 0x01);
  write_cmos_sensor(0x41D5, 0x0A);
  ...
  write_cmos_sensor(0x41E1, 0x9A);
  write_cmos_sensor(0x41E2, 0x01);
  write_cmos_sensor(0x41E3, 0x0A);
  ...
  write_cmos_sensor(0x41E9, 0xBF);
  write_cmos_sensor(0x41EA, 0x01);
  write_cmos_sensor(0x41EB, 0x0A);
  ...
  write_cmos_sensor(0x41F1, 0xE3);
  write_cmos_sensor(0x41F2, 0x01);
  write_cmos_sensor(0x41F3, 0x0A);
  ...
  write_cmos_sensor(0x416F, 0x0A);
  write_cmos_sensor(0x4170, 0x01);
  write_cmos_sensor(0x4171, 0x1A);
